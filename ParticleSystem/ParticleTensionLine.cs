...
namespace ParticleSystem
{
    ...
    class ParticleTensionLine : ParticleSystems
    {
        ...
        public ParticleTensionLine(string inName, int inParticleMaxAmount = 10, Vector inStartPos = null, Vector inEndPos = null, double inExplosion = 1, double inGravity = 1, double friction = 0.999, bool recycle = false, double turbulenceStrength = 0, double turbulenceSize = 0)
        {
            Name = inName;
